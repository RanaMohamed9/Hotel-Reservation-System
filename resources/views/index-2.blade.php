    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            <li class="nav-item"><a href="{{url ('booking-details')}}" class="nav-link">Booking Details</a></li>
    ...
    <section class="ftco-section">
      <div class="container">
        ...
        <div class="row d-flex">
          <div class="col-md-3 d-flex ftco-animate">
            <div class="blog-entry align-self-stretch">
              ...
              <div class="text mt-3 d-block">
                <h3 class="heading mt-3">Even the all-powerful Pointing has no control about the blind texts</h3>
                <div class="meta mb-3">
          ...
          <div class="col-md-3 d-flex ftco-animate">
            <div class="blog-entry align-self-stretch">
              <div class="block-20" style="background-image: url('images/image_2.jpg');">
              </div>
              <div class="text mt-3">
                <h3 class="heading mt-3">Even the all-powerful Pointing has no control about the blind texts</h3>
                <div class="meta mb-3">
          ...
          <div class="col-md-3 d-flex ftco-animate">
            <div class="blog-entry align-self-stretch">
              <div class="block-20" style="background-image: url('images/image_3.jpg');">
              </div>
              <div class="text mt-3">
                <h3 class="heading mt-3">Even the all-powerful Pointing has no control about the blind texts</h3>
                <div class="meta mb-3">
          ...
          <div class="col-md-3 d-flex ftco-animate">
            <div class="blog-entry align-self-stretch">
              <div class="block-20" style="background-image: url('images/image_4.jpg');">
              </div>
              <div class="text mt-3">
                <h3 class="heading mt-3">Even the all-powerful Pointing has no control about the blind texts</h3>
                <div class="meta mb-3">
